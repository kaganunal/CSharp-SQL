...
namespace Uygulama.KimlikDogrula {
    ...
    public interface KPSPublicSoap {
        ...
        Uygulama.KimlikDogrula.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<Uygulama.KimlikDogrula.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public Uygulama.KimlikDogrula.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(Uygulama.KimlikDogrula.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : Uygulama.KimlikDogrula.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<Uygulama.KimlikDogrula.KPSPublicSoap>, Uygulama.KimlikDogrula.KPSPublicSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Uygulama.KimlikDogrula.TCKimlikNoDogrulaResponse Uygulama.KimlikDogrula.KPSPublicSoap.TCKimlikNoDogrula(Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequest request) {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequest inValue = new Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequest();
            inValue.Body = new Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            Uygulama.KimlikDogrula.TCKimlikNoDogrulaResponse retVal = ((Uygulama.KimlikDogrula.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Uygulama.KimlikDogrula.TCKimlikNoDogrulaResponse> Uygulama.KimlikDogrula.KPSPublicSoap.TCKimlikNoDogrulaAsync(Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequest request) {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<Uygulama.KimlikDogrula.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequest inValue = new Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequest();
            inValue.Body = new Uygulama.KimlikDogrula.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((Uygulama.KimlikDogrula.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
    }
}
